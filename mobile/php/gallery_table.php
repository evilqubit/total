<div class="span4">
                	...
                	<div id="form_table" style="border:solid">
                        ...
                        <div class="thumb">
                         <a class="fancybox" rel="group" href="../app/gallery/<?php echo $row['image'];?>"><img src="../app/gallery/t/<?php echo $row['image'];?>" style="margin:9px; width:190px; height:124px"></a>
                          <span style="position:absolute;bottom:4px;right:10px;color:#034ea2;font-size:12px;font-family:\'Conv_HelveticaNeueLTStd-Md\';"><?php echo $row['name'];?>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<?php echo $row['votes'];?> Vote(s)</span>
                        </div>
